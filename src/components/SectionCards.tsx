        ...
        <section className="w-full mx-auto pb-20">
            ...
            <div className="relative w-full max-w-area-cards h-area-cards mx-auto">
                <Image
                    src={Card01}
                    alt="Card 01"
                    className="w-20 md:w-60 absolute top-8 left-4 md:left-44"
                />
                <Image
                    src={Card02}
                    alt="Card 02"
                    className="w-20 md:w-60 absolute left-8 md:left-0 bottom-60 md:bottom-32"
                />
                <Image
                    src={Card03}
                    alt="Card 03"
                    className="w-20 md:w-60 absolute bottom-20 md:bottom-0 left-72 md:left-80"
                />
                <Image
                    src={Card04}
                    alt="Card 04"
                    className="w-20 md:w-60 absolute top-0 right-4 md:right-32"
                />
                <Image
                    src={Card05}
                    alt="Card 05"
                    className="w-20 md:w-60 absolute right-6 md:right-0 bottom-80 md:bottom-28"
                />
                <Image
                    src={Card06}
                    alt="Card 06"
